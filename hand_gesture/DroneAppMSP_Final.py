...
class DroneAppMSP:
    def __init__(self, master):
        ...
        self.control_map = {
            'TAKEOFF':'t','LAND':'b', 'MAP_AREA':'r','INC':'i',
            'DEC':'k','RIGHT':'l','LEFT':'j',
            'YAW_LEFT':'q','YAW_RIGHT':'e', 'FORWARD':'w','BACKWARD':'s'
        }
        self.hand = [None] * 5
        self.ft = [4, 8, 12, 16, 20]
        self.drone = DroneKeyControl()
        self.drone.connect()
        self.in_action = False

        tk.Label(master, text="MSP Drone Controller", font=("Arial", 16, "bold")).pack(pady=10)
